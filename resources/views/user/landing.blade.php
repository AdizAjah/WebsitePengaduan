...
@endsection
    ...
    {{-- yield diambil dengan menggunakan section --}}
    {{-- extends itu mengambil semuanya --}}
...
@section('content')
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
            <div class="container">
                <div class="container-fluid">
                    {{-- Perbedaan container dan coiner fluid. Container fluid menyesuaikan layaknya air
                    sedangkan continer itu tetap --}}
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        @else
                            <ul class="navbar-nav text-center ml-auto">
                                <li class="nav-item">
                                    <button class="btn text-white" type="button" class="btn btn-warning"
                                        data-toggle="modal" data-target="#loginModal">
                                        {{-- btn-primary=biru, btn-danger=merah, btn-warning=kuning --}}
                                        Login
                                    </button>
                                </li>
    ...
    <div class="text-center">
        ...
        {{-- mb itu margin bottom dan mt itu margin top --}}
    </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 Deez • All rights reserved</p>
    </div>
</div>
{{-- Penutup Body --}}
